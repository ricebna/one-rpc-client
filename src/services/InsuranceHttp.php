...
------------------------------------------------------------------------------
    ...
    */
    class MatchGoodsRpc extends \OneRpcClient\RpcClientHttp { 
...
------------------------------------------------------------------------------
    ...
    */
    class ProductRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class BookingRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class MatchApplicationRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class UserRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class GoodsRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class GoodsTagRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class ProductTagRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class CacheStrategyRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class GuideRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
...
------------------------------------------------------------------------------
    ...
    */
    class DiseaseRpc extends \OneRpcClient\RpcClientHttp { 
        protected $secret = 'bcc7fece0b442b2a2fa53d17a637a3e6';
        protected $service_name = 'insurance';
